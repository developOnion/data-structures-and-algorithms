...
#include "../header/CircularLinkList.h"
...
template class CircularLinkList<int>;
template class NodeCSLL<int>;

template class CircularLinkList<double>;
template class NodeCSLL<double>;

template class CircularLinkList<char>;
template class NodeCSLL<char>;

template class CircularLinkList<std::string>;
template class NodeCSLL<std::string>;
