...
template class SingleLinkList<int>;
template class NodeSLL<int>;

template class SingleLinkList<double>;
template class NodeSLL<double>;

template class SingleLinkList<char>;
template class NodeSLL<char>;

template class SingleLinkList<std::string>;
template class NodeSLL<std::string>;
